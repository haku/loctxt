...
public class VodafoneLocation {
	...
	private static final String PROTECTED_RESOURCE_URL = "http://api.developer.vodafone.com/v2/location/queries/location?address=tel%3A447786142860&requestedAccuracy=1500";

	public static void main (String[] args) throws MalformedURLException, ParseException, JSONException
	{

		String redirect_uri = "http://www.example.com/";
		String scope = "GET-/location/queries/location";
		String apiKey = "cceed3fda53f40673dbe83ef23000a01";
